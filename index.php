...
<div class="container pb-3">
    <div class="row">
        <div class="col-sm-9 col-sm-7 col-lg-5 mx-auto">
            <div class="card-body">
            <form method="POST" action="email-script.php" class="form-signin pt-3">
                    <div class="mb-3">
                    <div class="form-label-group">
                            <label for="inputEmail">To [ Email Recipient] <span style="color: #FF0000"></span></label>
                            <input type="text" name="toEmail" id="toEmail" class="form-control" placeholder="Email address" required autofocus>
                        </div> <br/>

                    <div class="form-label-group">
                            <label for="inputEmail">From [ Email Sender ] <span style="color: #FF0000"></span></label>
                            <input type="text" name="fromEmail" id="fromEmail" class="form-control"  value="">
<!--                            /*readonly required autofocus>*/-->
                        </div> <br/>
                        
                        <label for="inputPassword">Subject [Email Subject] <span style="color: #FF0000"></span></label>
                        <div class="form-label-group">
                            <input type="text" id="subject" name="subject" class="form-control" placeholder="Subject" required>
                        </div><br/>
                        <label for="inputPassword">Message [Email Message] <span style="color: #FF0000"></span></label>
                        <div class="form-label-group">
                            <textarea  id="message" name="message" class="form-control" placeholder="Message" required ></textarea>
                        </div> <br/>
